        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" class="form-control" style="width: 150px;" name="quantite[]" /></td>
