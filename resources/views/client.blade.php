  ...
  <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12 mx-auto">
          ...
          <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ajouterFournisseurModal">Ajouter un Client</a>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="text-liste" id="ajouterFournisseurModalLabel">Ajouter un Client</h5>
                    ...
                    <select class="form-select" style="width: 400px;" aria-label="Default select example">
                     ...
                     <option value="2">particulier</option>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control"  style="width: 400px;" id="raisonSocial" name="raisonSocial">
                      </div>
                      <div class="mb-3">
                        <label for="nomResponsable" class="text-liste">Nom </label>
                        <input type="text" class="form-control" id="nomResponsable"  style="width: 400px;" name="nomResponsable">
                      </div>
                      <div class="mb-3">
                        <label for="prenomResponsable" class="text-liste">Prénom </label>
                        <input type="text" class="form-control" id="prenomResponsable"  style="width: 400px;"  name="prenomResponsable">
                      </div>
                      <div class="mb-3">
                        <label for="email" class="text-liste">Email</label>
                        <input type="email" class="form-control" id="email"  style="width: 400px;" name="email">
                      </div>
                      <div class="mb-3">
                        <label for="telephone" class="text-liste">Téléphone</label>
                        <input type="text" class="form-control" id="telephone"  style="width: 400px;" name="telephone">
                      </div>
                    </form>
                  </div>
        ...
        <div class="col-md-6">
          <form>
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="search" name="search" style="width: 300px;">
            </div>
          </form>
        </div>
        <hr>
