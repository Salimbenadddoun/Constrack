...
<!-- End Projets Nav -->
      ...
      <li class="nav-item">
        ...
        <i class="bi bi-cart-check"></i></i></i><span>Vente</span>
        </a>
      </li><!-- End achat Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{ url('/vente')}}">
        <i class="bi bi-cash-coin"></i></i></i><span>Reglement</span>
        </a>
      </li><!-- End achat Nav -->
  ...
  <main id="main" class="main">
    ...
    <div class="row">
      ...
      <div class="text-center">
        <a href="{{ url('/ajouterachat') }}" class="btn btn-primary">Ajouter un Achat</a>
      </div>
      <hr>
       <div class="row">
        <div class="col-md-6">
          ...
          <form>
            <div class="form-group">
              ...
              <select class="form-control" id="filter" name="filter">
                ...
                <option value="date">Date de Vente</option>
      ...
      <table class="table table-striped" style="font-size: 1.2em;">
        ...
        <tbody>
          <tr>
            ...
            <td>27 000,00 DA</td>
            <td>
              <a href="#" class="btn btn-sm btn-modifier">Détails</a>
              <a href="#" class="btn btn-sm btn-modifier">Modifier</a>
              <button type="button" class="btn btn-sm btn-supprimer"><i class="bi bi-trash-fill"></i></button>
            </td>
          </tr>
          <tr>
            <td>2</td>
